...
A = [
 ...
 dict(bucket='catalog', repo='logos-blockchain-ui', title='Blockchain node', primary='logos_node_1click', cat='Blockchain', icon='',
      desc='Community 1-click fork — run a Logos testnet node in one click. In-app onboarding (Quick start / Advanced), honest node states, an Earned-by-epoch chart, and Leader Rewards with a permanent claims ledger reconciled against the chain (shared with the Node Remote app, so phone claims show here too). Live Blend status, keystore backup, and a durable proposals tab.'),
...
ANDROID = [
 dict(title='Node Remote', ver='0.2.1', bytes=28188011, cat='Internet',
      apk='node-remote-0.2.1-arm64.apk',
