...
A = [
 ...
 dict(bucket='catalog', repo='logos-blockchain-ui', dir='', title='Blockchain node', ver='0.2.4', iface='Universal',
      cat='Blockchain', core=[], icon='', mods=['logos_node_1click','blockchain_module'],
      desc='Community 1-click fork — run a Logos blockchain node on the testnet in one click: sync to the tip, monitor and manage. Renders on Basecamp v0.2.3, syncs the 0.2.1 testnet. Proposals tab (blocks your node proposed) with a durable history that survives log pruning, leadership voucher count, LGO-formatted balances, a borderless dashboard, and a node settings modal.'),
