...
A = [
 ...
 dict(bucket='catalog', repo='receiver-basecamp', dir='', title='Receiver', ver='0.2.0.3', iface='Universal',
      cat='Streaming', core=['Messaging'], icon='', mods=['receiver_ui'],
      desc='Discover and listen to decentralized Logos radio broadcasts over LogosMessaging, via Tor.'),
